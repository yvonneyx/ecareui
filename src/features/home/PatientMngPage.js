...
export default function PatientMngPage(props) {
  ...
  return (
    <div className="home-patient-mng-page">
      <div className="home-patient-mng-page-header">
        <h1>Patients</h1>
        <Button
          type="primary"
          onClick={() => {
      ...
      <div className="home-patient-mng-page-table-header">
        <div className="home-patient-mng-page-table-header-left">
          <Search
        ...
        <div className="home-patient-mng-page-table-header-right">
